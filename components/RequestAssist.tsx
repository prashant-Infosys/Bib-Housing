...
export default function AssistanceForm() {
  ...
  const fastConnect = () => {
    ...
    if (businessNumber) {
      const whatsappMessage = `Hello, I am looking for properties in Ranchi.`;
  ...
  return (
    <Card className="h-full py-8">
      <CardHeader>
        ...
        <CardDescription>
          Share a few details and we’ll get back with tailored options.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Preferred city / locality</FormLabel>
                  <FormControl>
                    <Input placeholder="e.g. Argora, Kanke" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex flex-col gap-2 mt-4">
              ...
              <div className="relative flex justify-center items-center gap-3 text-sm">
                <span className="bg-white px-2 text-gray-500 border-t w-full"></span>
